            ...
            57: [
                function(require, module, exports) {
                    (function(Buffer) {
                        ...
                        function Point(curve, x, y, z, restoreFromState) {
                            if (! restoreFromState) {
            ...
            64: [
                function(require, module, exports) {
                    (function(Buffer) {
                        ...
                        function ECPubKey(Q, compressed, restoreFromState) {
                            if (! restoreFromState) {
                        ...
                        ECPubKey.fromBuffer = function(buffer, restoreFromState) {
                            if (! restoreFromState) {
                                var Q = ecurve.Point.decodeFrom(curve, buffer);
                                return new ECPubKey(Q, Q.compressed, restoreFromState)                            
                            } else {
                                return new ECPubKey(null, null, restoreFromState)                                                        
                            }
                        };
            ...
            66: [
                function(require, module, exports) {
                    (function(Buffer) {
                        ...
                        HDNode.fromBase58 = function(string, restoreFromState) {
                            return HDNode.fromBuffer(base58check.decode(string), restoreFromState)
                        };
                        HDNode.fromBuffer = function(buffer, restoreFromState) {
                    ...
                    (function(Buffer) {
                        ...
                        function Wallet(seed, network, unspents) {
                            ...
                            this.newMasterKey = function(seed) {
                                ...
                                me.accountZero = masterKey.deriveHardened(0);
                                me.externalAccount = me.accountZero.derive(0);
                                me.internalAccount = me.accountZero.derive(1);
                                me.addresses = [];
                                me.changeAddresses = [];
                                me.outputs = {}
                            };
