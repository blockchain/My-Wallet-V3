...
describe "Wallet", ->
  ...
  describe "decryptWallet()", ->
    ...
    it "should decrypt a legacy v1 wallet", ->
      # The first wallet version did not have an unencrypted wrapper
      data = ''
      ...
      expect(obj.success.calls.argsFor(0)[0].guid).toBe("339d7a46-1efb-4c3b-a8a7-69d54510e97f")


    it "should decrypt another legacy v1 wallet", ->
      # This one has double encryption enabled
      # The first wallet version did not have an unencrypted wrapper
      data = ''
      password = 'testpassword'
    ...
    it "should decrypt a test v1 wallet", ->
      # The first wallet version did not have an unencrypted wrapper
