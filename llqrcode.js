	...
	else
	{
		...
		image.onload=function(){
			...
			try{
				...
				qrcode.result = null;//"Cross domain image reading not supported in your browser! Save it to your computer then drag and drop the file!";
				if(qrcode.callback!=null)
					qrcode.callback(qrcode.result);
				return;
			}
            ...
            {
				console.log(e);
                qrcode.result = null;//"error decoding QR Code";
            }
			if(qrcode.callback!=null)
				qrcode.callback(qrcode.result);
		}
